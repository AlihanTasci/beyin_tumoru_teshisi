...
class MainWindow(QWidget):
    ...
    def detect_tumor(self):
        ...
        path = os.listdir("/Users/feeke/OneDrive/Belgeler/GitHub/beyin-tumoru-teshisi/Brain_Tumor/Training/")
        ...
        for cls in classes:
            pth = "/Users/feeke/OneDrive/Belgeler/GitHub/beyin-tumoru-teshisi/Brain_Tumor/Training/"+cls
        ...
        if os.listdir("/Users/feeke/OneDrive/Belgeler/GitHub/beyin-tumoru-teshisi/Brain_Tumor/Testing/idk_tumor/"):
            count = len(os.listdir("/Users/feeke/OneDrive/Belgeler/GitHub/beyin-tumoru-teshisi/Brain_Tumor/Testing/idk_tumor/"))
       
        if(os.listdir("/Users/feeke/OneDrive/Belgeler/GitHub/beyin-tumoru-teshisi/Brain_Tumor/Testing/idk_tumor/") != 0):
            for a in os.listdir("/Users/feeke/OneDrive/Belgeler/GitHub/beyin-tumoru-teshisi/Brain_Tumor/Testing/idk_tumor/"):
             count = count + 1

        if(os.listdir("/Users/feeke/OneDrive/Belgeler/GitHub/beyin-tumoru-teshisi/Brain_Tumor/Testing/idk_tumor/")):
            
            plt.figure(figsize = (12,8))
            p = os.listdir("/Users/feeke/OneDrive/Belgeler/GitHub/beyin-tumoru-teshisi/Brain_Tumor/Testing/")
            c=1
            row = 0
            col = 0
            
            for j in os.listdir("/Users/feeke/OneDrive/Belgeler/GitHub/beyin-tumoru-teshisi/Brain_Tumor/Testing/idk_tumor/")[:count]:
                
                plt.subplot(3,3,c)


                img_path = "/Users/feeke/OneDrive/Belgeler/GitHub/beyin-tumoru-teshisi/Brain_Tumor/Testing/idk_tumor/" + j


                img = cv2.imread("/Users/feeke/OneDrive/Belgeler/GitHub/beyin-tumoru-teshisi/Brain_Tumor/Testing/idk_tumor/"+j,0)
